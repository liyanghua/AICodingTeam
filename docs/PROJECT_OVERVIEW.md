...
- [`app_generation_data_analysis_node_spec.md`](app_generation_data_analysis_node_spec.md): product and interaction spec for turning business strategy data-analysis flows into generated app nodes with goals, inputs, execution steps, data-table outputs, and insight outputs.
- [`app_generation_data_analysis_node_technical_design.md`](app_generation_data_analysis_node_technical_design.md): technical contract for `analysis_node_view`, data-analysis node generation, evidence boundaries, and workbench rendering.
- [`app_generation_data_analysis_node_implementation_plan.md`](app_generation_data_analysis_node_implementation_plan.md): implementation plan for adding `analysis_node_view`, rendering the five-part data-analysis workspace, retiring legacy API-selection UI, and validating the flow end to end.
- [`app_generation_data_analysis_execution_strategy_plan.md`](app_generation_data_analysis_execution_strategy_plan.md): execution strategy plan for consuming reviewed field coverage, fetching real API data, filling business output fields, and moving source metadata out of the final wide table.
- [`app_generation_topn_product_table_missing_fields_fix_plan.md`](app_generation_topn_product_table_missing_fields_fix_plan.md): implementation plan for repairing TOP N product table missing fields, including category-name-to-category-ID resolution, live probe row extraction, value-aware field repair, deterministic derivations, and Agent draft fills.
